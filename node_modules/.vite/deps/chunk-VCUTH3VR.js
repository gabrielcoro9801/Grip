...
__name5(useStateMachine, "useStateMachine");
var Presence = __name5((props) => {
...
function usePresence(present) {
  ...
  useLayoutEffect2(() => {
    if (node) {
      ...
      const handleAnimationEnd = __name5((event) => {
      ...
      const handleAnimationStart = __name5((event) => {
...
__name5(usePresence, "usePresence");
...
__name5(useStableComposedRefs, "useStableComposedRefs");
function getAnimationName(styles) {
  return (styles == null ? void 0 : styles.animationName) || "none";
}
__name5(getAnimationName, "getAnimationName");
...
//# sourceMappingURL=chunk-VCUTH3VR.js.map
